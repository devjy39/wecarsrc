...
class simple_kinematics:
    ...
    def __init__(self):
        ...
        self.rpm_gain = 4614
        self.steering_angle_to_servo_again = -1.2135
        ...
        while not rospy.is_shutdown():
            ...
            if self.is_servo == True and self.is_speed == True:
                ...
                theta_dat = self.speed * sin(self.servo_angle_rad)/self.L/20
                ...
                self.theta = self.theta+theta_dat
    ...
    def servo_command_callback(self,msg):
        ...
        self.servo_angle_rad = (servo_value - self.steering_angle_to_servo_offset)/self.steering_angle_to_servo_again
